...
export interface FiltrosDatasPedidoCompra {
...
interface FiltroDatasPopoverPedidoCompraProps {
  filtros: FiltrosDatasPedidoCompra;
  onChange: (updates: Partial<FiltrosDatasPedidoCompra>) => void;
}
...
export default function FiltroDatasPopoverPedidoCompra({ filtros, onChange }: FiltroDatasPopoverPedidoCompraProps) {
  ...
  const f = filtros;
  const temAlgumaData = f.data_emissao_ini || f.data_emissao_fim || f.data_entrega_ini || f.data_entrega_fim;
